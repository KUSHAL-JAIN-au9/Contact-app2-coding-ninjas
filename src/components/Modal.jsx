      ...
      <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
            <h3 class="font-bold text-gray-800 dark:text-white">Add contact</h3>
            <button
              type="button"
              onClick={() => {
                setmodalToggle(false);
                ...
                <>
                  ...
                  {isEdit ? (
                    <input
                      ...
                      {...(isEdit && {
                        value:
                          formState[item.label] || formState?.address?.city,
                      })}
                      // value={
                      //   (modalToggle && isEdit && formState[item.label]) ||
                    ...
                    <input
                      ...
                      autofocus
                      onChange={handleFormContact}
                      // value={isEdit && formState[item.label]}
                    />
                  )}
                </>
              );
